...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for beliefs in livingGhostPositionDistributions:
            mostLikelyPositions.append(beliefs.argMax())
        closestGhost = min(mostLikelyPositions, key=lambda pos: self.distancer.getDistance(pacmanPosition, pos))
        closestAction = min(legal, key=lambda action: self.distancer.getDistance(closestGhost, Actions.getSuccessor(pacmanPosition, action)))
